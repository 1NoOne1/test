...
+---------------------------------+-------------------------------------------------------------------+
| ../roles/Raid_R620              | Reset the RAID forcefully and re-create RAID-1 across first two   | 
|                                 | disks. Runs only when `raid_force` is set to true in              |
|                                 | `inventory\hosts`                                                 |
+---------------------------------+-------------------------------------------------------------------+
| ../roles/Raid_R730              | install and configure grub                                        |
+---------------------------------+-------------------------------------------------------------------+
| ../roles/iDrac_Settings         | set system hostname                                               |
+---------------------------------+-------------------------------------------------------------------+
| ../roles/iDrac_BIOS_Settings    | hardware raid controller management tools                         |
+---------------------------------+-------------------------------------------------------------------+
